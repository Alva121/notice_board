            ...
            <div class="card-body">
               {!!  Form::open(['route' => 'students.store','method'=>'post']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        {!! Form::select('dept', [] , null , ['class' =>[ 'form-control','col-md-3'],'id'=>'dept']) !!}
                        {!! Form::select('sem', [], null , ['class' =>[ 'form-control','col-md-4', 'offset-1'],'id'=>'sem']) !!}
                        {!! Form::select('sec', [], null , ['class' =>[ 'form-control','col-md-3', 'offset-1'],'id'=>'sec']) !!}
